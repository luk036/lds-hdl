...
# Validate
print("Validating against yosys_schema.json...")
...
if __name__ == "__main__":
    ...
    try:
        netlist = read_yosys_json("synth/vdc_16_synth.json")
        print("Successfully loaded netlist from synth/vdc_16_synth.json")
